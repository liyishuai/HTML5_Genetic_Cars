/* ==========================================================================
 * HTML5 Genetic Cars - Bare/graph-only bundle (no npm/browserify required)
 * Open graphs.html directly in a browser.
 * ========================================================================== */
(function () {
  ...
  var carConstruct = (function () {
    ...
    return { carConstants: getCarConstants, generateSchema: generateSchema };
  })();
  ...
  */
  ...
  /* --- genetic-algorithm/manage-round.js --- */
  var manageRoundGA = (function () {
  ...
  /* --- simulated-annealing/manage-round.js --- */
  ...
  */
  ...
  /* --- bare.js (entry) --- */
  var manageRound = {
    genetic: manageRoundGA,
    annealing: manageRoundSA,
  };
  // Global Vars
